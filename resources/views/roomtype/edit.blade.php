                    ...
                    <form action="{{url('admin/roomtype/'.$data->id.'')}}" method="post" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Detail</th>
                                <td>
                                    <textarea name="detail" type="text" class="form-control">{{$data->detail}}</textarea>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($data->roomtypeimgs as $img)
                                                <td class="imgcol{{$img->id}}">
                                                    ...
                                                    <p class="mt-2"><button type="button" onclick="return confirm('Are you sure you want to delete this image')" data-image-id="{{$img->id}}" class="btn btn-danger btn-sm delete-image"><i class="fa fa-trash"></i></button></p>
                                                </td>                                                
                                            @endforeach
                                        </tr>
                                    </table>
